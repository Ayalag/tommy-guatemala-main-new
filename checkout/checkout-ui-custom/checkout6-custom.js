...
function avisoEnvioGratis() {
    if (document.querySelector("body > div.container.container-main.container-cart > div.checkout-container.row-fluid.cart-active > div.cart-template.full-cart.span12.active > div.summary-template-holder > div.row-fluid.summary > div.span5.totalizers.summary-totalizers.cart-totalizers.pull-right > div:nth-child(2) > div > div.accordion-body.collapse.in > div > table > tbody.totalizers-list > tr > td.monetary") != null) {
        let subtotal = document.querySelector("body > div.container.container-main.container-cart > div.checkout-container.row-fluid.cart-active > div.cart-template.full-cart.span12.active > div.summary-template-holder > div.row-fluid.summary > div.span5.totalizers.summary-totalizers.cart-totalizers.pull-right > div:nth-child(2) > div > div.accordion-body.collapse.in > div > table > tbody.totalizers-list > tr > td.monetary").innerText;
        subtotal = subtotal.split("Q ")
        subtotal = 1000 - subtotal[1]
        console.log(subtotal)
        if (subtotal > 0) {
            if (document.querySelector(".aviso-envio-gratis") != null) {
                document.querySelector(".aviso-envio-gratis").innerText = "Te faltan Q " + subtotal + " para tener envio gratis."
                document.querySelector(".aviso-envio-gratis").classList.remove("success")
            } else {
                $("#cartLoadedDiv > div.cart > table > tbody").append("<div class='aviso-envio-gratis'>Te faltan Q " + subtotal + " para tener envio gratis.</div>")
            }
        } else {
            if (document.querySelector(".aviso-envio-gratis") != null) {
                document.querySelector(".aviso-envio-gratis").innerText = "Felicitaciones, tienes envio gratis!";
                $(".aviso-envio-gratis").addClass("success");
            } else {
                $("#cartLoadedDiv > div.cart > table > tbody").append("<div class='aviso-envio-gratis success'>Felicitaciones, tienes envio gratis!</div>")
            }
        }
    }
}
...
$(window).on('orderFormUpdated.vtex', function (evt, orderForm) {
    ...
    var addNosto = setInterval(() => {
        if ($(".cart-more-options").length > 0) {
            ...
            $(".summary-template-holder .row-fluid.summary").css("height", "180px");
